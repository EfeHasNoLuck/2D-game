...
//				gp.projectileList.add(projectile);
	...
	public void checkStartChasingDistance(Entity target, int distance, int rate) {
	...
	public void checkStopChasingDistance(Entity target, int distance, int rate) {
	...
	public void getRandomDirection(int value) {

		actionLockCounter++;
		
		if(actionLockCounter > value) {
